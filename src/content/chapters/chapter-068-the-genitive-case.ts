...
export const chapter068: ChapterDefinition = {
    ...
    rules: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Notice that der now appears as the feminine and plural genitive article — the same three letters you already know as the masculine nominative article and as the feminine dative article. Only the noun and the context tell you which one is meant.',
  ...
  exercises: [
    ...
    },
    {
      ...
      prompt: 'Das ist das Auto des ___ Mannes. (der kleine Mann)',
      options: [
        { id: 'a', text: 'kleinen' },
        { id: 'b', text: 'kleiner' },
        { id: 'c', text: 'kleines' },
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'während'],
      instruction: 'Drag the genitive preposition meaning "during" into the slot.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'wegen'],
      instruction: 'Drag the genitive preposition meaning "because of" into the slot.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'trotz'],
      instruction: 'Drag the genitive preposition meaning "despite" into the slot.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'innerhalb'],
      instruction: 'Drag the genitive preposition meaning "within" into the slot.',
      prompt: '___ einer Woche kommt er zurück.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'außerhalb'],
      instruction: 'Drag the genitive preposition meaning "outside of" into the slot.',
      prompt: '___ der Stadt gibt es viele Wälder.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['genitive', 'prepositions', 'statt'],
      instruction: 'Drag the genitive preposition meaning "instead of" into the slot.',
      prompt: '___ des Autos nimmt er den Bus.',
