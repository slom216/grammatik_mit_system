...
export const chapter067: ChapterDefinition = {
  ...
  exercises: [
    ...
    },
    {
      ...
      type: 'matching',
      level: 'recognition',
      grammarFocus: ['position-verbs', 'placement-verbs', 'verb-pairs'],
      instruction: 'Match each position verb with its placement counterpart.',
      prompt: 'Match the static position verb to the matching placement verb.',
      pairs: [
        { id: 'ch67-ex33-p1', left: 'stehen', right: 'stellen' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'recognition',
      grammarFocus: ['placement-verbs', 'position-verbs', 'verb-pairs'],
      instruction: 'Match each placement verb with its position counterpart.',
      prompt: 'Match the placement verb to the matching static position verb.',
      pairs: [
        { id: 'ch67-ex34-p1', left: 'stellen', right: 'stehen' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'controlled',
      grammarFocus: ['verb-pairs', 'strong-vs-weak-verbs', 'praeteritum'],
      instruction: 'Match each present-tense verb to its simple-past (Präteritum) form.',
      prompt: 'Match each verb to its correct Präteritum form.',
      pairs: [
        { id: 'ch67-ex35-p1', left: 'steht (stehen)', right: 'stand' },
        { id: 'ch67-ex35-p2', left: 'liegt (liegen)', right: 'lag' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'controlled',
      grammarFocus: ['verb-pairs', 'perfekt', 'participle'],
      instruction: 'Match each infinitive to its Perfekt participle.',
      prompt: 'Match each verb to its correct past participle.',
      pairs: [
        { id: 'ch67-ex36-p1', left: 'stehen', right: 'gestanden' },
        { id: 'ch67-ex36-p2', left: 'liegen', right: 'gelegen' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'production',
      grammarFocus: ['position-verbs', 'wo', 'sentence-meaning'],
    ...
    },
    {
      ...
      type: 'matching',
      level: 'production',
      grammarFocus: ['placement-verbs', 'wohin', 'sentence-meaning'],
      instruction: 'Match each German sentence to its English translation.',
      prompt: 'Match the German sentences to their English translations.',
      pairs: [
        {
    ...
    },
    {
      ...
      type: 'matching',
      level: 'transfer',
      grammarFocus: ['reflexive', 'sich-setzen', 'sentence-meaning'],
    ...
    },
    {
      ...
      type: 'matching',
      level: 'production',
      grammarFocus: ['verb-pairs', 'infinitive-meaning'],
      instruction: 'Match each verb to its English infinitive meaning.',
      prompt: 'Match each German verb to its English meaning.',
      pairs: [
        { id: 'ch67-ex42-p1', left: 'stehen', right: 'to stand / be standing' },
        { id: 'ch67-ex42-p2', left: 'stellen', right: 'to put something upright' },
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'production',
      grammarFocus: ['position-verbs', 'placement-verbs', 'verb-choice'],
      instruction: 'Drag the correct verb into the slot.',
      prompt: 'Setze das richtige Verb ein.',
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'production',
      grammarFocus: ['sitzen', 'sich-setzen', 'reflexive'],
      instruction: 'Drag the correct verb form into the slot.',
      prompt: 'Setze das richtige Verb ein.',
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'production',
      grammarFocus: ['position-verbs', 'dative', 'sitzen'],
      instruction: 'Drag the correct article into the slot.',
      prompt: 'Setze den richtigen Artikel ein.',
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'production',
      grammarFocus: ['placement-verbs', 'accusative', 'setzen'],
      instruction: 'Drag the correct article into the slot.',
      prompt: 'Setze den richtigen Artikel ein.',
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'transfer',
      grammarFocus: ['two-way-prepositions', 'dative', 'stehen'],
      instruction: 'Drag the correct article into the slot.',
      prompt: 'Setze den richtigen Artikel ein.',
    ...
    },
    {
      ...
      type: 'dragToSlots',
      level: 'transfer',
      grammarFocus: ['two-way-prepositions', 'accusative', 'stellen'],
      instruction: 'Drag the correct article into the slot.',
      prompt: 'Setze den richtigen Artikel ein.',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'verb-choice', 'transitivity'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Ich stehe die Lampe auf den Tisch.',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'accusative', 'legen'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Ich lege das Buch auf dem Tisch.',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'verb-choice', 'stehen'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Der Stuhl liegt am Fenster.',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'sich-setzen', 'accusative'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Setz dich auf dem Stuhl!',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'verb-choice', 'setzen'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Die Mutter sitzt das Kind auf den Stuhl.',
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['error-correction', 'praeteritum', 'strong-verbs'],
      instruction: 'Click the word that contains an error.',
      prompt: 'Der Teppich liegte früher im Wohnzimmer.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['position-verbs', 'word-order', 'stehen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'The wardrobe stands in the corner.',
      segments: [
        { id: 's1', text: 'Der' },
        { id: 's2', text: 'Schrank' },
        { id: 's3', text: 'steht' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'controlled',
      grammarFocus: ['placement-verbs', 'word-order', 'stellen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'I put the wardrobe in the corner.',
      segments: [
        { id: 's1', text: 'Ich' },
        { id: 's2', text: 'stelle' },
        { id: 's3', text: 'den' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'production',
      grammarFocus: ['position-verbs', 'word-order', 'liegen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'The book is lying on the sofa.',
      segments: [
        { id: 's1', text: 'Das' },
        { id: 's2', text: 'Buch' },
        { id: 's3', text: 'liegt' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'production',
      grammarFocus: ['placement-verbs', 'word-order', 'legen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'I am laying the book on the sofa.',
      segments: [
        { id: 's1', text: 'Ich' },
        { id: 's2', text: 'lege' },
        { id: 's3', text: 'das' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'production',
      grammarFocus: ['position-verbs', 'word-order', 'sitzen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'He is sitting on the chair.',
      segments: [
        { id: 's1', text: 'Er' },
        { id: 's2', text: 'sitzt' },
        { id: 's3', text: 'auf' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'transfer',
      grammarFocus: ['sich-setzen', 'word-order', 'reflexive'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'He sits down on the chair.',
      segments: [
        { id: 's1', text: 'Er' },
        { id: 's2', text: 'setzt' },
        { id: 's3', text: 'sich' },
    ...
    },
    {
      ...
      grammarFocus: ['position-verbs', 'word-order', 'stehen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'The picture stands against the wall.',
      segments: [
        { id: 's1', text: 'Das' },
        { id: 's2', text: 'Bild' },
        { id: 's3', text: 'steht' },
    ...
    },
    {
      ...
      grammarFocus: ['placement-verbs', 'word-order', 'stellen'],
      instruction: 'Put the words in the correct order to form a natural sentence.',
      prompt: 'I put the picture against the wall.',
      segments: [
        { id: 's1', text: 'Ich' },
        { id: 's2', text: 'stelle' },
        { id: 's3', text: 'das' },
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'recognition',
      grammarFocus: ['hängen', 'position-verbs', 'verb-selection'],
      instruction: 'Choose the verb that matches the static position of the lamp.',
      prompt: 'Die Lampe ___ an der Decke.',
      options: [
        { id: 'a', text: 'hängt' },
        { id: 'b', text: 'steht' },
        { id: 'c', text: 'liegt' },
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'controlled',
      grammarFocus: ['case-choice', 'dative', 'stehen'],
      instruction: 'Choose the correct article for this static position sentence.',
      prompt: 'Das Auto steht vor ___ Haus. (das Haus, neuter)',
      options: [
        { id: 'a', text: 'dem' },
        { id: 'b', text: 'das' },
        { id: 'c', text: 'den' },
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'controlled',
      grammarFocus: ['case-choice', 'accusative', 'stellen'],
      instruction: 'Choose the correct article for this placement sentence.',
      prompt: 'Ich stelle das Auto vor ___ Haus. (das Haus, neuter)',
      options: [
        { id: 'a', text: 'das' },
        { id: 'b', text: 'dem' },
        { id: 'c', text: 'den' },
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'production',
      grammarFocus: ['verb-choice', 'haengen', 'transitivity'],
      instruction: 'Choose the verb that matches the action of putting up the picture.',
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'transfer',
      grammarFocus: ['perfekt', 'auxiliary', 'sitzen'],
      instruction: 'Choose the correct perfect-tense auxiliary.',
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'transfer',
      grammarFocus: ['error-correction', 'setzen', 'accusative'],
      instruction: 'Choose the sentence that is grammatically correct.',
      prompt: 'Which sentence is correct?',
      options: [
        { id: 'a', text: 'Die Mutter setzt das Kind auf dem Stuhl.' },
        { id: 'b', text: 'Die Mutter setzt das Kind auf den Stuhl.' },
        { id: 'c', text: 'Die Mutter sitzt das Kind auf den Stuhl.' },
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'transfer',
      grammarFocus: ['verb-choice', 'haengen', 'position-verbs'],
      instruction: 'Choose the verb that matches how a coat rests on a hook.',
      prompt: 'Der Mantel ___ am Haken.',
      options: [
        { id: 'a', text: 'hängt' },
        { id: 'b', text: 'liegt' },
        { id: 'c', text: 'steht' },
    ...
    },
    {
      ...
      type: 'textInput',
      level: 'controlled',
      grammarFocus: ['haengen', 'position-verbs', 'dative'],
      instruction: 'Write the correct form of hängen. Capitalisation is not checked.',
      prompt: 'Ergänze das Verb (hängen): Das Bild ___ an der Wand. (es, Präsens)',
      acceptedAnswers: ['hängt'],
      answerMode: 'caseInsensitive',
      placeholder: 'hängt',
      maxLength: 15,
      explanation:
    ...
    },
    {
      ...
      placeholder: 'hänge',
      maxLength: 15,
      explanation: 'The ich-form present tense of the transitive, weak hängen is hänge.',
    },
    {
      id: 'ch67-ex-81',
      chapterNumber: 67,
