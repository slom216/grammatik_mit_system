...
export const chapter061: ChapterDefinition = {
  ...
  exercises: [
    ...
    },
    {
      ...
      options: [
        { id: 'a', text: 'Ich hätte gern einen Kaffee, bitte.' },
        { id: 'b', text: 'Gib mir einen Kaffee!' },
        { id: 'c', text: 'Ich will einen Kaffee.' },
        { id: 'd', text: 'Kaffee!' },
      ],
      correctOptionId: 'a',
      explanation:
    ...
    },
    {
      ...
      grammarFocus: ['konjunktiv-ii', 'polite-request'],
      instruction: 'Write the missing Konjunktiv II form. Capitalisation is not checked.',
      prompt: 'Ich ___ gern einen Tee. (haben, Konjunktiv II – höfliche Bestellung)',
      acceptedAnswers: ['hätte'],
      answerMode: 'caseInsensitive',
      placeholder: 'hätte',
      maxLength: 15,
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'polite-request', 'word-order'],
      instruction: 'Put the chunks in order to form a polite formal request.',
      prompt: 'Bilde eine höfliche Bitte aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Könnten Sie' },
        { id: 's2', text: 'mir' },
        { id: 's3', text: 'bitte' },
        { id: 's4', text: 'helfen?' },
      ],
    ...
    },
    {
      ...
      options: [
        { id: 'a', text: 'Du solltest früher ins Bett gehen.' },
        { id: 'b', text: 'Du sollst früher ins Bett gehen.' },
        { id: 'c', text: 'Du musst sofort schlafen.' },
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'polite-request'],
      instruction: 'Drag the correct word into the slot to open a formal polite request.',
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'unreal-condition', 'wenn-clause'],
      instruction: 'Choose the correct form for the wenn-clause.',
      prompt: 'Wenn ich mehr Zeit ___, würde ich mehr lesen.',
      options: [
        { id: 'a', text: 'hätte' },
        { id: 'b', text: 'habe' },
        { id: 'c', text: 'hatte' },
    ...
    },
    {
      ...
      level: 'recognition',
      grammarFocus: ['konjunktiv-ii', 'polite-request'],
      instruction: 'Match each polite pattern to its typical use.',
      prompt: 'Ordne die höflichen Muster ihrer Verwendung zu.',
      pairs: [
        { id: 'p1', left: 'Könnten Sie...?', right: 'formelle Bitte' },
        { id: 'p2', left: 'Könntest du...?', right: 'informelle Bitte' },
    ...
    },
    {
      ...
      grammarFocus: ['konjunktiv-ii', 'wenn-clause', 'word-order'],
      instruction: 'Choose the sentence with the same meaning, but without wenn.',
      prompt: 'Wenn du Zeit hättest, könntest du mitkommen.',
      options: [
        { id: 'a', text: 'Hättest du Zeit, könntest du mitkommen.' },
        { id: 'b', text: 'Du hättest Zeit, könntest du mitkommen.' },
        { id: 'c', text: 'Zeit hättest du, könntest du mitkommen.' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'unreal-condition', 'wenn-clause', 'word-order'],
      instruction: 'Put the chunks in order to form a correct unreal condition.',
      prompt: 'Bilde einen irrealen Bedingungssatz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Wenn ich Zeit hätte,' },
        { id: 's2', text: 'würde' },
        { id: 's3', text: 'ich' },
        { id: 's4', text: 'kommen.' },
      ],
    ...
    },
    {
      ...
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'wenn-clause', 'word-order'],
      instruction: 'Put the chunks in order to form the same sentence without wenn.',
      prompt: 'Bilde denselben Satz ohne wenn aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Hätte ich Zeit,' },
        { id: 's2', text: 'würde' },
        { id: 's3', text: 'ich' },
        { id: 's4', text: 'kommen.' },
      ],
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'production',
      grammarFocus: ['konjunktiv-ii', 'unreal-condition'],
      instruction: 'Find the token that breaks the unreal condition and correct it.',
      prompt: 'Wenn ich Zeit hätte, werde ich dich besuchen.',
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Ich will einen Tisch für zwei.' },
        { id: 'c', text: 'Gibt es einen Tisch für zwei?' },
    ...
    },
    {
      ...
      prompt: 'Bilde einen irrealen Bedingungssatz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Wenn du mehr üben würdest,' },
        { id: 's2', text: 'würdest' },
        { id: 's3', text: 'du' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'hypothetical-advice'],
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'meaning-distinction'],
      instruction: 'Choose the form that expresses a cautious, hedged probability.',
      prompt: 'Das ___ falsch sein, aber ich bin nicht sicher.',
      options: [
        { id: 'a', text: 'dürfte' },
        { id: 'b', text: 'muss' },
        { id: 'c', text: 'soll' },
    ...
    },
    {
      ...
      prompt: 'Bilde einen irrealen Bedingungssatz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Wenn es regnen würde,' },
        { id: 's2', text: 'blieben' },
        { id: 's3', text: 'wir' },
        { id: 's4', text: 'zu Hause.' },
      ],
    ...
    },
    {
      ...
      level: 'production',
      grammarFocus: ['konjunktiv-ii', 'wish-construction'],
      instruction: 'Choose the correct German translation.',
      prompt: 'I wish I had more patience.',
      options: [
        { id: 'a', text: 'Ich wünschte, ich hätte mehr Geduld.' },
        { id: 'b', text: 'Ich wünsche, ich habe mehr Geduld.' },
        { id: 'c', text: 'Ich will mehr Geduld haben.' },
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'wish-construction', 'word-order'],
      instruction: 'Put the chunks in order to form a correct wish.',
      prompt: 'Bilde einen Wunschsatz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Ich wünschte,' },
        { id: 's2', text: 'ich' },
        { id: 's3', text: 'hätte' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Ich mache eine Weltreise.' },
        { id: 'c', text: 'Ich werde eine Weltreise machen.' },
    ...
    },
    {
      ...
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'wish-construction', 'word-order'],
      instruction: 'Put the chunks in order to form a correct wish exclamation.',
      prompt: 'Bilde einen Wunsch-Ausruf aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Wenn ich doch nur' },
    ...
    },
    {
      ...
      level: 'production',
      grammarFocus: ['konjunktiv-ii', 'wish-construction'],
      instruction: 'Find the token that breaks the wish-construction and correct it.',
      prompt: 'Ich wünsche, ich hätte mehr Zeit.',
    ...
    },
    {
      ...
      type: 'singleChoice',
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'unreal-condition', 'word-order'],
      instruction: 'Choose the grammatically correct unreal condition.',
      prompt: 'Choose the grammatically correct sentence.',
      options: [
        { id: 'a', text: 'Wenn ich mehr Geld hätte, würde ich ein Haus kaufen.' },
        { id: 'b', text: 'Wenn ich mehr Geld habe, würde ich ein Haus kaufen.' },
        { id: 'c', text: 'Wenn ich mehr Geld hätte, kaufe ich ein Haus.' },
    ...
    },
    {
      ...
      prompt: 'Bilde einen irrealen Bedingungssatz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Wenn ich reich wäre,' },
        { id: 's2', text: 'würde' },
        { id: 's3', text: 'ich' },
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'meaning-distinction'],
      instruction: 'Choose the sentence expressing a strong probability, not advice.',
      prompt: 'Choose the sentence expressing a strong probability, not advice.',
      options: [
        { id: 'a', text: 'Er müsste bald ankommen.' },
        { id: 'b', text: 'Er sollte bald ankommen.' },
        { id: 'c', text: 'Er könnte bald ankommen.' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'hypothetical-advice', 'word-order'],
      instruction: 'Put the chunks in order to form a correct sentence.',
      prompt: 'Bilde einen Satz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'An deiner Stelle' },
        { id: 's2', text: 'würde' },
        { id: 's3', text: 'ich' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'controlled',
      grammarFocus: ['konjunktiv-ii', 'sollte-advice', 'word-order'],
      instruction: 'Put the chunks in order to form a correct sentence.',
      prompt: 'Bilde einen Satz aus den Wortgruppen.',
      segments: [
        { id: 's1', text: 'Du' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Sie sollen mehr schlafen und Sport treiben.' },
        { id: 'c', text: 'Sie müssen sofort ins Krankenhaus.' },
    ...
    },
    {
      ...
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'meaning-distinction'],
      instruction: 'Match each modal form to the meaning it expresses.',
      prompt: 'Ordne jede Modalform ihrer Bedeutung zu.',
      pairs: [
        { id: 'p1', left: 'könnte', right: 'Möglichkeit' },
        { id: 'p2', left: 'müsste', right: 'starke Wahrscheinlichkeit' },
        { id: 'p3', left: 'sollte', right: 'Ratschlag' },
    ...
    },
    {
      ...
      level: 'transfer',
      grammarFocus: ['konjunktiv-ii', 'wish-construction', 'word-order'],
      instruction: 'Choose the grammatically correct verb-first wish exclamation.',
      prompt: 'Choose the grammatically correct wish exclamation (no wenn).',
      options: [
        { id: 'a', text: 'Wäre ich doch nur geduldiger!' },
        { id: 'b', text: 'Ich wäre doch nur geduldiger!' },
        { id: 'c', text: 'Doch wäre ich nur geduldiger!' },
    ...
    },
    {
      ...
      acceptedAnswers: [
        ...
        'Ich wollte, du wärst pünktlich',
        'Ich wollte, du wärest pünktlich.',
        'Ich wollte, du wärest pünktlich',
      ],
      answerMode: 'normalized',
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'b', text: 'Wenn ich ein Vogel wäre, würde ich fliegen.' },
        { id: 'c', text: 'Wenn ich mehr Zeit hätte, würde ich mehr lesen.' },
    ...
    },
    {
      ...
      level: 'production',
      grammarFocus: ['konjunktiv-ii', 'polite-request'],
      instruction: 'Find the token that breaks the polite request and correct it.',
      prompt: 'Könnten Sie mir bitte das Salz gibt?',
    ...
    },
    {
      ...
      level: 'production',
      grammarFocus: ['konjunktiv-ii', 'polite-request', 'register'],
      instruction: 'Choose the most polite way to ask a waiter for a receipt.',
      prompt: 'You want to politely ask a waiter for a receipt.',
      options: [
        { id: 'a', text: 'Könnten Sie mir bitte eine Quittung geben?' },
        { id: 'b', text: 'Gib mir eine Quittung!' },
        { id: 'c', text: 'Ich will eine Quittung.' },
