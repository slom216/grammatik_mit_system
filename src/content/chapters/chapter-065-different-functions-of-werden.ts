...
export const chapter065: ChapterDefinition = {
    ...
    rules: [
      {
        ...
        paragraphs: [
          ...
          'These three jobs grew out of one verb meaning "to become": the future and the passive both developed from it (English "will" is not related — it comes from Old English willan, a cousin of German wollen) — but in modern German they behave as three functionally distinct patterns that you must be able to tell apart on sight, because the three-way ambiguity of the bare word "wird" is exactly what makes werden tricky.',
  ...
  exercises: [
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'lexical-werden', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Die Situation wird komplizierter.',
      options: [
        { id: 'a', text: 'lexical "become" (+ predicate adjective)' },
        { id: 'b', text: 'future auxiliary (+ infinitive)' },
        { id: 'c', text: 'passive auxiliary (+ past participle)' },
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'passive-auxiliary', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Die Fenster werden geputzt.',
      options: [
        { id: 'a', text: 'passive auxiliary (+ past participle)' },
        { id: 'b', text: 'future auxiliary (+ infinitive)' },
        { id: 'c', text: 'lexical "become" (+ predicate adjective)' },
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'future-auxiliary', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Ich werde morgen ankommen.',
      options: [
        { id: 'a', text: 'future auxiliary (+ infinitive)' },
        { id: 'b', text: 'passive auxiliary (+ past participle)' },
        { id: 'c', text: 'lexical "become" (+ predicate adjective)' },
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'passive-auxiliary', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Der Kuchen wird gebacken.',
      options: [
        { id: 'a', text: 'passive auxiliary (+ past participle)' },
        { id: 'b', text: 'future auxiliary (+ infinitive)' },
        { id: 'c', text: 'lexical "become" (+ predicate noun)' },
        { id: 'd', text: 'simple past form' },
      ],
      correctOptionId: 'a',
      explanation:
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'future-auxiliary', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Du wirst das Rennen gewinnen.',
      options: [
        { id: 'a', text: 'future auxiliary (+ infinitive)' },
        { id: 'b', text: 'passive auxiliary (+ past participle)' },
        { id: 'c', text: 'lexical "become" (+ predicate noun)' },
    ...
    },
    {
      ...
      grammarFocus: ['werden', 'passive-auxiliary', 'function-identification'],
      instruction: 'Identify the function of werden in this sentence.',
      prompt: 'Die Aufgabe wird gelöst.',
      options: [
        { id: 'a', text: 'passive auxiliary (+ past participle)' },
        { id: 'b', text: 'future auxiliary (+ infinitive)' },
        { id: 'c', text: 'lexical "become" (+ predicate adjective)' },
    ...
    },
    {
      ...
      options: [
        ...
        { id: 'c', text: 'Der Kuchen wird gegessen.' },
    ...
    },
    {
      ...
      placeholder: 'wurdet',
      maxLength: 15,
      explanation: 'The simple-past ihr-form of werden is wurdet.',
    },
    {
      id: 'ch65-ex-46',
      chapterNumber: 65,
    ...
    },
    {
      ...
      type: 'matching',
      level: 'recognition',
      grammarFocus: ['werden', 'function-identification'],
      ...
      pairs: [
        { id: 'ch65-ex53-p1', left: 'Er wird Arzt.', right: 'lexical "become"' },
    ...
    },
    {
      ...
      type: 'matching',
      level: 'recognition',
      grammarFocus: ['werden', 'function-identification', 'translation'],
    ...
    },
    {
      ...
      type: 'matching',
      level: 'controlled',
      grammarFocus: ['werden', 'geworden', 'worden', 'function-identification'],
    ...
    },
    {
      ...
      type: 'matching',
      level: 'controlled',
      grammarFocus: ['werden', 'function-identification', 'perfect-tense'],
      instruction: 'Match each sentence with the function werden is performing.',
      prompt: 'Match the sentences to the correct function of werden.',
      pairs: [
        {
    ...
    },
    {
      ...
      instruction: 'Match each pronoun with its correct present-tense werden form.',
      prompt: 'Match the pronouns to the correct present-tense form of werden.',
      pairs: [
        { id: 'ch65-ex57-p1', left: 'ich (Präsens)', right: 'werde' },
    ...
    },
    {
      ...
      level: 'controlled',
      grammarFocus: ['werden', 'infinitive-vs-participle', 'function-identification'],
      instruction: 'Match each sentence with what immediately follows werden in it.',
      prompt: 'Match each sentence to what follows werden.',
      pairs: [
        { id: 'ch65-ex58-p1', left: 'Er wird Lehrer.', right: 'predicate noun' },
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'transfer',
      grammarFocus: ['werden', 'geworden', 'worden', 'lexical-werden', 'common-mistake'],
      instruction: 'One word is wrong. Identify it and give the correction.',
      prompt: 'Find the error in this sentence.',
    ...
    },
    {
      ...
      level: 'production',
      grammarFocus: ['werden', 'lexical-werden', 'sentence-structure'],
      instruction: 'Drag the segments into the correct order.',
      prompt: 'Build the sentence: The situation is getting more and more complicated.',
      segments: [
        { id: 'ch65-ex69-s1', text: 'Die' },
        { id: 'ch65-ex69-s2', text: 'Situation' },
        { id: 'ch65-ex69-s3', text: 'wird' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'production',
      grammarFocus: ['werden', 'future-auxiliary', 'sentence-structure'],
      instruction: 'Drag the segments into the correct order.',
      prompt: 'Build the sentence: She will move to Berlin next year.',
      segments: [
        { id: 'ch65-ex70-s1', text: 'Sie' },
        { id: 'ch65-ex70-s2', text: 'wird' },
        { id: 'ch65-ex70-s3', text: 'nächstes' },
        { id: 'ch65-ex70-s4', text: 'Jahr' },
        { id: 'ch65-ex70-s5', text: 'nach' },
    ...
    },
    {
      ...
      type: 'sentenceOrdering',
      level: 'production',
      grammarFocus: ['werden', 'passive-auxiliary', 'sentence-structure'],
      instruction: 'Drag the segments into the correct order.',
      prompt: 'Build the sentence: The letter is being written by her.',
      segments: [
        { id: 'ch65-ex71-s1', text: 'Der' },
        { id: 'ch65-ex71-s2', text: 'Brief' },
        { id: 'ch65-ex71-s3', text: 'wird' },
        { id: 'ch65-ex71-s4', text: 'von' },
    ...
    },
    {
      ...
      segments: [
        ...
        { id: 'ch65-ex72-s3', text: 'ist' },
        { id: 'ch65-ex72-s4', text: 'gestern' },
