...
export const chapter053: ChapterDefinition = {
  ...
  exercises: [
    ...
    },
    {
      ...
      instruction: 'Fill in the missing adverb. Capitalisation is not checked.',
      prompt: 'Die Apotheke finden Sie ___ um die Ecke, direkt gegenüber der Kirche.',
    ...
    },
    {
      ...
      instruction: 'Fill in the missing adverb. Capitalisation is not checked.',
      prompt: 'Biegen Sie an der nächsten Kreuzung ___ ab, dann sehen Sie das Museum.',
    ...
    },
    {
      ...
      instruction: 'Drag the correct word into the slot.',
      prompt: 'Der Supermarkt ist nicht weit, er liegt gleich ___ um die Ecke.',
    ...
    },
    {
      ...
      prompt: 'Sie geht ___, und ich komme gleich ___.',
      templateParts: ['Sie geht ', ', und ich komme gleich ', '.'],
      slots: [
