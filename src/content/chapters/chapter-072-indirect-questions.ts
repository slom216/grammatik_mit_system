  ...
  exercises: [
    ...
    },
    {
      ...
      dialogue: [
        {
          speaker: 'Ben',
          german: 'Die Party fängt um acht an.',
          english: 'The party starts at eight.',
        },
        {
          speaker: 'Anna',
    ...
    },
    {
      ...
      dialogue: [
        ...
        {
          speaker: 'Kollege',
          german: 'Sie hat gesagt, dass sie am Montag zurückkommt.',
          english: "She said she's coming back on Monday.",
        },
      ],
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'controlled',
      grammarFocus: ['error-correction', 'question-word', 'verb-final'],
      instruction: 'Find the incorrect word and give its correction.',
      prompt: 'Frage: Wo ist der Bahnhof? → Ich weiß nicht, dass der Bahnhof ist.',
      tokens: ['Ich', 'weiß', 'nicht,', 'dass', 'der', 'Bahnhof', 'ist.'],
      errorTokenIndex: 3,
      correction: 'wo',
      explanation:
        'An indirect question keeps the question word of the direct question (Wo ist der Bahnhof?) as its conjunction, with the verb at the end: Ich weiß nicht, wo der Bahnhof ist.',
    },
    {
      id: 'ch72-ex-52',
      chapterNumber: 72,
    ...
    },
    {
      ...
      type: 'errorSpotting',
      level: 'production',
      grammarFocus: ['error-correction', 'ob', 'perfect-tense'],
      instruction: 'Find the incorrect word and give its correction.',
      prompt: 'Ich weiß nicht, wenn er die Prüfung bestanden hat.',
      tokens: [
        'Ich',
        'weiß',
        'nicht,',
      ...
      correction: 'ob',
      explanation:
        'A yes/no question (Hat er die Prüfung bestanden?) becomes an indirect question with ob ("whether"), not wenn: Ich weiß nicht, ob er die Prüfung bestanden hat.',
    },
    {
      id: 'ch72-ex-54',
      chapterNumber: 72,
    ...
    },
    {
      ...
      instruction: 'Find the incorrect word and give its correction.',
      prompt: 'Ich frage mich, ob du mir helfen können.',
      tokens: ['Ich', 'frage', 'mich,', 'ob', 'du', 'mir', 'helfen', 'können.'],
      errorTokenIndex: 7,
      correction: 'kannst.',
      explanation:
        'The modal verb goes to the very end of the clause, after the infinitive, but it is still conjugated to agree with du: ob du mir helfen kannst.',
    },
    {
      id: 'ch72-ex-57',
      chapterNumber: 72,
    ...
    },
    {
      ...
      dialogue: [
        ...
        {
          speaker: 'Paul',
          german: 'Nein, ich weiß es nicht. Und am Montag?',
          english: "No, I don't know. And on Monday?",
        },
      ],
      prompt:
